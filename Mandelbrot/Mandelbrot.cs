...
namespace Fractal
{
    internal class Mandelbrot
    {
        ...
        public Mandelbrot(int maxIterations = 200, decimal centerReal = 0, decimal centerIm = 0, decimal zoom = 1, int pixelWidth = 1920, int pixelHeight = 1080, int maxTileSize = 64)
        {
            decimal complexWidth = 4;
            decimal complexHeight = (decimal)pixelHeight / (decimal)pixelWidth * complexWidth;
            complexWidth = complexWidth / zoom;
            complexHeight = complexHeight / zoom;
            decimal edgeReal = centerReal - complexWidth / 2;
            decimal edgeIm = centerIm - complexHeight / 2;
            ...
            int pixelHeight)
        {
            ...
            decimal edgeReal = posReal - complexWidth / 2;
            decimal edgeIm = posIm - complexHeight / 2;
            Calculate(
                maxIterations,
                edgeReal,
                edgeIm,
